...
const FEATURES: Feature[] = [
  {
    icon: Truck,
    title: 'Fast Delivery',
    description: 'Order-mu tiba dalam waktu kurang dari 2 jam.',
  ...
  },
  {
    ...
    description: 'Lebih dari 50.000 products dari petani lokal dan trusted brands.',
  ...
  },
  {
    ...
    description: 'Berbagai pilihan pembayaran dengan bank-grade encryption.',
    iconBg: 'bg-blue-100',
  ...
  },
  {
    icon: Headphones,
    title: '24/7 Support',
    description: 'Tim kami siap bantu kapanpun kamu butuhkan.',
