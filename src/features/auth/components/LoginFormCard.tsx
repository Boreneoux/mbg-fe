...
import { Eye, EyeOff, ShoppingCart, Smile } from 'lucide-react';
      ...
      <div className="w-full max-w-sm lg:max-w-lg bg-white rounded-2xl shadow-2xl p-6 sm:p-10">
        ...
        <div className="mb-7">
          ...
          <p className="text-sm text-muted-foreground">
            Masuk untuk lanjutkan belanja kamu.
          </p>
        </div>
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-white px-3 text-xs text-muted-foreground">atau masuk dengan</span>
          </div>
        </div>
